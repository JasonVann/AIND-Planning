            ...
            for cargo in self.cargos:
                for plane in self.planes:
                    for airport in self.airports:
                        ...
                        action = Action(expr("Load({}, {}, {})".format(cargo, plane, airport)), [precond_pos, precond_neg], [effect_add, effect_rem])
                        loads.append(action)
            return loads
            ...
            for cargo in self.cargos:
                for plane in self.planes:
                    for airport in self.airports:
                        ...
                        action = Action(expr("Unload({}, {}, {})".format(cargo, plane, airport)), [precond_pos, precond_neg], [effect_add, effect_rem])
